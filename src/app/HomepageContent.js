...
export default function HomepageContent(){
  ...
  return (
    <div className="h-screen w-full overflow-hidden relative bg-linear-to-b from-sky-400 via-sky-300 to-orange-200">
      ...
      <div className="absolute top-8 right-10 z-20" ref={el => homeElementsRef.current[1] = el}>
        <motion.button 
          ...
          className="bg-white text-gray-800 px-4 py-2 rounded-lg text-base font-medium transition-colors duration-300 hover:bg-blue-50 translate-y-1 cursor-pointer"
